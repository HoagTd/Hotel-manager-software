...
public class GUIMenu extends JFrame implements ActionListener,KeyListener{
	/**
	 * 
	 */
	...
	public GUIMenu(int check) {
		...
		menuBar.setPreferredSize(new Dimension(rong, 100));
		...
		meimPhong = new JMenuItem("Quản lý phòng (Ctrl + 2)", new ImageIcon(".\\image\\bed32.png"));
		meimDatPhong = new JMenuItem("Đặt phòng (Crtl + 3)", new ImageIcon(".\\image\\check-in32.png"));
		meimTraPhong = new JMenuItem("Trả phòng (Ctrl + 4)", new ImageIcon(".\\image\\checkout32.png"));
		meimChuyenPhong = new JMenuItem("Chuyển phòng (Ctrl + 5)",new ImageIcon(".\\image\\changeRoom32.png"));
		meimHuyPhong = new JMenuItem("Hủy phòng (Ctrl + 6)",new ImageIcon(".\\image\\cancel32.png"));
		menuPhong.add(meimPhong);
		menuPhong.add(meimDatPhong);
		menuPhong.add(meimTraPhong);
		menuPhong.add(meimChuyenPhong);
		menuPhong.add(meimHuyPhong);
		meimDichVu = new JMenuItem("Quản lý dịch vụ (Ctrl + 7)",new ImageIcon(".\\image\\service32.png"));
//		meimThanhToanDichVu = new JMenuItem("Thanh toán dịch vụ (Ctrl + 7)",new ImageIcon(".\\image\\iconthanhtoan32.png"));
		menuDichVu.add(meimDichVu);
//		menuDichVu.add(meimThanhToanDichVu);
		meimKhachHang = new JMenuItem("Quản lý khách hàng (Ctrl + 8)", new ImageIcon(".\\image\\customer32.png"));
		menuKhachHang.add(meimKhachHang);
		meimThongKePhong = new JMenuItem("Thống kê doanh thu phòng(Shift + 1)",new ImageIcon(".\\image\\bed.png"));
		meimThongKeDichVu = new JMenuItem("Thống kê doanh thu dịch vụ(Shift + 2)",new ImageIcon(".\\image\\service.png"));
		meimThongKeTong = new JMenuItem("Thống kê doanh thu tổng (Shift + 3)",new ImageIcon(".\\image\\analysis.png"));
		meimThongKeDatPhong = new JMenuItem("Thống kê số lần đặt phòng (Shift + 4)", new ImageIcon(".\\image\\check-in32.png"));
		menuThongKe.add(meimThongKePhong);
		menuThongKe.add(meimThongKeDichVu);
		menuThongKe.add(meimThongKeTong);
		menuThongKe.add(meimThongKeDatPhong);
		menuBar.add(new JLabel(new ImageIcon(".\\image\\managermenu.png")));
		menuBar.add(Box.createHorizontalStrut(20));
		menuBar.add(lblUser = new JLabel("Phan Văn Thông"));
		lblUser.setFont(new Font("SansSerif",Font.BOLD,17));
		...
		menuBar.add(Box.createHorizontalStrut(rong-1520));
		menuKhachHang.setPreferredSize(new Dimension(190, 100));
		...
		menuBar.add(Box.createHorizontalStrut(rong-100));
		...
		pMain.setPreferredSize(new Dimension(rong-20, cao-320));
		...
		meimThongKePhong.addActionListener(this);
		meimTraPhong.addActionListener(this);
//		meimThanhToanDichVu.addActionListener(this);
		meimChuyenPhong.addActionListener(this);
		meimThongKeDichVu.addActionListener(this);
		meimThongKeTong.addActionListener(this);
		meimThongTin.addActionListener(this);
		meimHuongDanSuDung.addActionListener(this);
		meimThongKeDatPhong.addActionListener(this);
		meimHuyPhong.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(meinNhanVien)) {
			...
			try {
				UIManager.setLookAndFeel("com.jtattoo.plaf.bernstein.BernsteinLookAndFeel");
				new GUITimKhachHangDatPhong(this);
				this.dispose();
			} catch (Exception e1) {
				e1.printStackTrace();
			}
		}else if(o.equals(meimThongKePhong)) {
			doiPanel(new GUIThongKePhong(this));
...
//		}
		...
		}else if(o.equals(meimThongKeDichVu)) {
			doiPanel(new GUIThongKeDichVu(this));
		}else if(o.equals(meimThongKeTong)) {
			doiPanel(new GUIThongKeTong(this));
		}else if(o.equals(meimHuongDanSuDung)) {
			new GUIHuongDanSuDung(this);
		}else if(o.equals(meimThongTin)) {
			new GUIThongTin(this);
		}else if(o.equals(meimThongKeDatPhong)) {
			doiPanel(new GUIThongKeDatPhong(this));
		}else if(o.equals(meimHuyPhong)) {
			doiPanel(new GUIDanhSachPhongHuy(this));
		}
	}
	@Override
	...
	public void keyReleased(KeyEvent e) {
		if(e.isControlDown() && e.getKeyCode() == KeyEvent.VK_1) {
			...
			doiPanel(new GUIDanhSachPhongChuyen(this));
		}else if(e.isShiftDown() && e.getKeyCode() == KeyEvent.VK_2) {
			doiPanel(new GUIThongKePhong(this));
		}else if(e.isShiftDown() && e.getKeyCode() == KeyEvent.VK_3) {
			doiPanel(new GUIThongKeTong(this));
...
class GUITimKhachHangDatPhong extends JFrame implements ActionListener,MouseListener{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	...
	public GUITimKhachHangDatPhong(Frame frameCha){
		Dimension manHinh = Toolkit.getDefaultToolkit().getScreenSize();
